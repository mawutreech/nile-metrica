          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="nm-card p-6">
              ...
              <p className="mt-2 text-4xl font-semibold tracking-tight">
                ...
                <span className="ml-1 text-lg text-slate-500">{indicator.unit || ""}</span>
              </p>
              ...
              <div className="mt-8 space-y-4 text-sm text-slate-600">
                <div>
                  ...
                  <p className="mt-1">{indicator.description || "No description available."}</p>
                </div>
                <div>
                  <p className="font-medium text-slate-900">Source</p>
                  <p className="mt-1">{indicator.source_agency?.name || "Unknown source"}</p>
                </div>
                <div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-slate-200 text-sm">
                <thead className="bg-slate-50">
                  <tr>
                    <th className="px-6 py-3 text-left font-medium text-slate-600">Period</th>
